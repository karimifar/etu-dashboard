...
var data={
    ...
    Policy:{
        ...
        'Includes ENDS and Other Tobacco Products (hookah, etc.)': [11,11,11,11,11,11,11,21,12,11,21,11,11,21,11],
        'Policy Communication (signage)': [11,12,11,11,11,11,11,11,31,11,21,12,11,21,11],
        'Enforcement Procedures': [31,12,31,11,11,11,31,11,31,21,22,12,12,12,12],
        'Tobacco‑Free Hiring': [13,12,13,11,13,12,13,13,13,13,13,13,13,13,13]
    },
    Cessation:{
        'Tobacco Cessation Program Offered': [11,11,11,11,11,11,11,11,11,11,11,11,11,11,11],
        'Individual Counseling Offered': [11,33,11,33,33,11,21,11,12,11,12,12,11,11,11],
